# API tests are performed based on the 13 objects listed below. 
# We are guaranteed to have 13 static objects according to the documentation.


class ExpectedData:

    @staticmethod
    def get_all_objects_data():
        return [{'id': '1', 'name': 'Google Pixel 6 Pro', 'data': {'color': 'Cloudy White', 'capacity': '128 GB'}},
    ...
    @staticmethod
    def get_object_with_id_7_data():
        return {'id': '7', 'name': 'Apple MacBook Pro 16',
                'data': {'year': 2019, 'price': 1849.99, 'CPU model': 'Intel Core i9', 'Hard disk size': '1 TB'}}

    @staticmethod
    def get_object_with_id_3_5_10_data():
        return [{'id': '3', 'name': 'Apple iPhone 12 Pro Max', 'data': {'color': 'Cloudy White', 'capacity GB': 512}},
                {'id': '5', 'name': 'Samsung Galaxy Z Fold2', 'data': {'price': 689.99, 'color': 'Brown'}},
                {'id': '10', 'name': 'Apple iPad Mini 5th Gen', 'data': {'Capacity': '64 GB', 'Screen size': 7.9}}]
