...
class TestAPI:
    ...
    def test_get_all_objects_200_expected(self):
        ...
        assert expected_all_objects_data == actual_all_objects_data, \
    ...
    def test_get_single_object_by_id_200_expected(self):
        ...
        assert expected_object_data == actual_object_data, \
    ...
    def test_get_objects_by_ids_200_expected(self):
        ...
        assert get_objects_response.status_code == 200, 'Objects with given ids NOT found.'
        ...
        assert expected_objects_data == actual_objects_data, \
    ...
    def test_add_new_object_200_expected(self):
        ...
        assert add_new_object_response.status_code == 200, 'Object has NOT been created.'
        ...
        assert get_new_object_response.status_code == 200, 'Object with given id does NOT exist.'
        ...
        expected_new_object_data = {'id': new_object_id} | new_object_payload | \
                                   {'createdAt': new_object_creation_date_and_time}
        actual_new_object_data = add_new_object_response.json()
        assert expected_new_object_data == actual_new_object_data, \
    ...
    def test_update_object_200_expected(self):
        ...
        updated_object_response = APIClient.update_object_by_id(new_object_id, updated_object_payload)
        ...
        assert expected_object_color == actual_updated_object_color, \
    ...
    def test_update_object_name_200_expected(self):
        ...
        update_object_name_response = APIClient.update_object_name_by_id(new_object_id, payload)
        assert update_object_name_response.status_code == 200, 'Update unsuccessful.'

        # check if name has been updated
        assert update_object_name_response.json()['name'] == payload['name'], \
    ...
    def test_delete_object_200_expected(self):
        ...
        assert delete_object_response.status_code == 200, 'Object with given id has NOT been deleted successfully.'
        ...
        assert get_deleted_object_response.status_code == 404, 'Object with given id has NOT been deleted.'
    ...
    def test_add_new_object_with_incorrect_payload_400_expected(self):
        ...
        assert add_new_object_response.status_code == 400, 'Object should NOT have been created.'
    ...
    def test_delete_object_that_does_not_exist_404_expected(self):
        ...
        delete_object_response = APIClient.delete_single_object_by_id(self._get_random_id())
